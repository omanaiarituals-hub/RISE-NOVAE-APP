    ...
    <div style={{ minHeight: '100vh', background: '#FAF7F2', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ padding: '20px', maxWidth: 500, margin: '0 auto' }}>
        ...
        <div style={{ background: '#1A1A1A', borderRadius: 20, padding: '20px', marginBottom: 16, position: 'relative', overflow: 'hidden' }}>
          ...
          <Link href="/program/1" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: '#C4956A', color: 'white', padding: '10px 18px', borderRadius: 10, fontSize: 12, fontWeight: 600, textDecoration: 'none' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10, marginBottom: 20 }}>
          {DEMO_MODULES.map(m => (
            <Link key={m.id} href={m.href} style={{ background: m.color, borderRadius: 14, padding: '16px 12px', textAlign: 'center', textDecoration: 'none', display: 'block', border: '1px solid rgba(196,149,106,0.08)', transition: 'transform 0.2s' }}>
