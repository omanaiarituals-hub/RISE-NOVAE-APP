    ...
    return (
      <div className="min-h-screen bg-novae-cream flex items-center justify-center p-6">
        <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-sm border border-novae-beige/30">
          ...
          <p className="text-novae-anthracite/60 text-sm mb-6">
            Ton agent NOVAÉ te connaît déjà. Retourne à l'accueil pour commencer ta journée.
          </p>
          <button
            onClick={() => router.push('/')}
            className="btn-primary w-full text-center py-3 rounded-xl bg-novae-gold text-white font-medium"
          >
            Retour à l'accueil →
          </button>
        </div>
      ...
      <div className="min-h-screen bg-novae-cream flex items-center justify-center p-6">
        <div className="max-w-lg w-full">
          <div className="text-center mb-8">
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-novae-gold to-novae-rose flex items-center justify-center text-white text-3xl font-serif mx-auto mb-6 shadow-lg">
              N
            </div>
            ...
            <p className="text-novae-anthracite/60 text-sm leading-relaxed">
              Ces réponses permettent à ton agent IA de créer un accompagnement{' '}
              <strong>vraiment personnalisé</strong>, basé sur la psychologie positive et les neurosciences.
            </p>
          </div>

          <div className="bg-white rounded-2xl p-5 mb-4 border border-novae-beige/20 shadow-sm">
            <label className="block text-xs text-novae-anthracite/60 mb-2 font-medium uppercase tracking-wide">
              Comment veux-tu que NOVAÉ t'appelle ?
            </label>
            <input
              type="text"
              value={pseudo}
              onChange={e => setPseudo(e.target.value.slice(0, 30))}
              placeholder="Ex: Léa, Sarah..."
              className="w-full p-3 bg-novae-cream/50 border border-novae-beige/40 rounded-xl text-sm text-novae-anthracite placeholder-novae-anthracite/30 focus:outline-none focus:ring-2 focus:ring-novae-gold/30"
              autoFocus
            />
            <p className="text-xs text-novae-anthracite/40 mt-2">
              Ton prénom, un surnom, ce que tu veux. Visible uniquement dans la communauté.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 mb-6 border border-novae-beige/20 shadow-sm">
            ...
            <div className="space-y-2">
              {[
                'Identifier tes freins réels (pas les symptômes)',
                'Adapter le programme à ton énergie actuelle',
                'Personnaliser le ton de ton coach IA',
          ...
          <button
            ...
            className={`w-full py-4 rounded-2xl font-medium text-sm tracking-wide transition-colors shadow-sm ${
              pseudo.trim()
                ? 'bg-novae-anthracite text-white hover:bg-novae-gold'
                : 'bg-novae-beige/30 text-novae-anthracite/30 cursor-not-allowed'
            }`}
          >
            Commencer mon profil →
          </button>
          <p className="text-center text-xs text-novae-anthracite/30 mt-3">
            3 minutes · Confidentiel · Modifiable à tout moment
          </p>
        </div>
      </div>
    )
    ...
    return (
      <div className="min-h-screen bg-novae-cream flex items-center justify-center p-6">
        <div className="text-center">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-novae-gold to-novae-rose flex items-center justify-center text-white text-3xl font-serif mx-auto mb-6 shadow-lg animate-pulse">
            N
          </div>
